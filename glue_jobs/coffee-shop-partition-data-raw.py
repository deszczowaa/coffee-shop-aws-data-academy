...
glueContext.write_dynamic_frame.from_options(frame = raw_pastry_inventory,
            connection_type = "s3",
            connection_options = {"path": "s3://clean-coffee-shop-ms/pastry-inventory/", "partitionKeys": ["date"]},
            format = "parquet")
...
glueContext.write_dynamic_frame.from_options(frame = raw_sales_reciept,
            connection_type = "s3",
            connection_options = {"path": "s3://clean-coffee-shop-ms/sales-reciept/", "partitionKeys": ["date"]},
            format = "parquet")
...
glueContext.write_dynamic_frame.from_options(frame = raw_sales_target,
            connection_type = "s3",
            connection_options = {"path": "s3://clean-coffee-shop-ms/sales-target/"},
            format = "parquet")
